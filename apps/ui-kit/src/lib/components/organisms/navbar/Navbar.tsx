...
import type { NavbarItemProps } from '@/lib/components/molecules/navbar-item/NavbarItem';
import { NavbarItem } from '@/lib/components/molecules/navbar-item/NavbarItem';
